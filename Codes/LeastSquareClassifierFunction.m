...
%         Train Classification Matrix | [K x K]
%         Test Classification Matrix | [K x K]
...
%% Function
function[weight_matrix, train_pred, test_pred,train_class_mat, test_class_mat,train_conf_mat,test_conf_mat] = LeastSquareClassifierFunction(train_feature_matrix, train_labels, test_feature_matrix, test_labels)
